    ...
    <div className="row justify-content-center m-5">
        ...
        {loading && (<Loading/>)}
          ...
          {error && (<Error error='Email already registred' />)}
            ...
            <h2 style={{fontSize : '45px'}} className="text-center">Register</h2>
            <div>
                ...
                <button className='btn mt-2 mb-3' onClick={register} >SIGN UP</button>
                <br />
                <a style={{color:'black'}} href="/login">Log In Here</a>
            </div>
        </div>
    </div>
  )
